...
TMPDIR_PREFIX = "vuicoin_func_test_"
...
class BitcoinTestFramework(metaclass=BitcoinTestMetaClass):
    """Base class for a vuicoin test script.

    Individual vuicoin test scripts should subclass this class and override the set_test_params() and run_test() methods.
    ...
    def setup(self):
        ...
        fname_bitcoind = os.path.join(
            ...
            "src",
            "vuicoind" + config["environment"]["EXEEXT"],
        )
        fname_bitcoincli = os.path.join(
            config["environment"]["BUILDDIR"],
            "src",
            "vuicoin-cli" + config["environment"]["EXEEXT"],
        )

...
"""Verify that starting vuicoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start vuicoin with -h for help text")
        ...
        self.log.info("Start vuicoin with -version for version information")
        ...
        self.log.info("Start vuicoind with -fakearg to make sure it does not start")

...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " vuicoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  vuicoin-tx [options] <hex-tx> [commands]  Update hex-encoded vuicoin transaction\n" +
            "or:     vuicoin-tx [options] -create [commands]   Create hex-encoded vuicoin transaction\n" +
            "\n";

# Support for Output Descriptors in Vuicoin Core

Since Vuicoin Core v0.17, there is support for Output Descriptors. This is a
...
existing Vuicoin Core wallets, a convenience function `combo` is

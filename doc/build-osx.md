...
2.  Build Vuicoin Core:
    ...
    Configure and build the headless Vuicoin Core binaries as well as the GUI (if Qt is found).
...
## Disable-wallet mode
When the intention is to run only a P2P node without a wallet, Vuicoin Core may be
...
The first time you run vuicoind, it will start downloading the blockchain. This process could
